  ...
  return (
    ...
    >
      <nav className="flex w-full items-center justify-between px-[clamp(1.5rem,6vw,4rem)] py-5">
        <Link href="/" aria-label="CEO Rules, home" className="relative z-10 flex items-center">
          <BrandLogo tone={darkText ? "ivory" : "blue"} priority className="h-[clamp(14px,1.4vw,18px)] w-auto" />
        </Link>
        ...
        <button
          ...
          aria-expanded={open}
          className="relative z-10 -mr-2 ml-auto flex h-10 w-10 items-center justify-center lg:hidden"
        >
        ...
        <div className="hidden items-center gap-x-[clamp(1.25rem,2.4vw,2.5rem)] lg:flex">
          {nav.links.map((l) => {
      ...
      <div
        className={`fixed inset-0 z-0 bg-bg transition-opacity duration-300 ease-out-quart lg:hidden ${
